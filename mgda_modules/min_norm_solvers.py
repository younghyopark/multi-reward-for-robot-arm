...
class MinNormSolver:
    ...
    def _next_point(cur_val, grad, n):
        ...
        # print(tm1<1e-7)
        # print(tm2<1e-7)
        # print(np.sum(tm1<1e-7))
        if isinstance(tm1, np.ndarray):
        ...
        if isinstance(proj_grad, np.ndarray):
            proj_grad = torch.from_numpy(proj_grad)
        if isinstance(cur_val, np.ndarray):
            cur_val = torch.from_numpy(cur_val)

        # print(type(proj_grad))
        # print(type(t))
        # print(type(cur_val))
